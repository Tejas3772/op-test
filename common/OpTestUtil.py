...
class OpTestUtil():
    ...
    def Email_git(self,linux_path ,repo):
        connection = self.conf.host()
        ...
        Regards
        PPC KBOT
        """.format(gcc_version, machine_type, error_message,err_long,kernel_version, machine_type, gcc_version, commit,commit, commit, fix_description)
        print(subject)
        print(body)
